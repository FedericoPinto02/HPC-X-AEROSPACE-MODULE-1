...
\{\+: .callout .note\} {\bfseries{Note\+:}} g\+Mock lives in the {\ttfamily testing} name space. For readability, it is recommended to write {\ttfamily using \+::testing\+::\+Foo;} once in your file before using the name {\ttfamily Foo} defined by g\+Mock. We omit such {\ttfamily using} statements in this section for brevity, but you should do it in your own code.\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md118}{}\doxysection{Creating Mock Classes}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md118}
...
\end{DoxyItemize}\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md119}{}\doxysubsection{Dealing with unprotected commas}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md119}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md120}{}\doxysubsection{Mocking Private or Protected Methods}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md120}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md121}{}\doxysubsection{Mocking Overloaded Methods}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md121}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md122}{}\doxysubsection{Mocking Class Templates}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md122}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md123}{}\doxysubsection{Mocking Free Functions}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md123}
...
Alternatively, instead of introducing a new interface, you can rewrite your code to accept a std\+::function instead of the free function, and then use \href{\#MockFunction}{\texttt{ Mock\+Function}} to mock the std\+::function.\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md124}{}\doxysubsection{Old-\/\+Style $<$tt$>$\+MOCK\+\_\+\+METHODn$<$/tt$>$ Macros}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md124}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md125}{}\doxysubsection{Alternative to Mocking Concrete Classes}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md125}
...
Instead, you can define a {\ttfamily File\+Ops} interface and an {\ttfamily IOOps} interface and split {\ttfamily System}\textquotesingle{}s functionalities into the two. Then you can mock {\ttfamily IOOps} without mocking {\ttfamily File\+Ops}.\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md126}{}\doxysubsection{Delegating Calls to a Real Object}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md126}
...
(Why don\textquotesingle{}t we just write {\ttfamily \{ return foo.\+Concrete(str); \}}? If you do that, {\ttfamily Mock\+Foo\+::\+Concrete()} will be called (and cause an infinite recursion) since {\ttfamily Foo\+::\+Concrete()} is virtual. That\textquotesingle{}s just how C++ works.)\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md128}{}\doxysection{Using Matchers}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md128}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md129}{}\doxysubsection{Matching Argument Values Exactly}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md129}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md130}{}\doxysubsection{Using Simple Matchers}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md130}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md131}{}\doxysubsection{Performing Different Actions Based on the Arguments}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md131}
...
Now, if {\ttfamily foo.\+Do\+This()} is called with a value less than 5, `\textquotesingle{}a'{\ttfamily will be returned; otherwise}\textquotesingle{}b\textquotesingle{}\`{} will be returned.\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md132}{}\doxysubsection{Matching Multiple Arguments as a Whole}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md132}
...
Note that if you want to pass the arguments to a predicate of your own (e.\+g. {\ttfamily .With(Args$<$0, 1$>$(Truly(\&\+My\+Predicate)))}), that predicate MUST be written to take a {\ttfamily std\+::tuple} as its argument; g\+Mock will pass the {\ttfamily n} selected arguments as {\itshape one} single tuple to the predicate.\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md133}{}\doxysubsection{Using Matchers as Predicates}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md133}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md134}{}\doxysubsection{Using Matchers in googletest Assertions}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md134}
See \href{reference/assertions.md\#EXPECT_THAT}{\texttt{ {\ttfamily EXPECT\+\_\+\+THAT}}} in the Assertions Reference.\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md135}{}\doxysubsection{Using Predicates as Matchers}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md135}
...
Note that the predicate function / functor doesn\textquotesingle{}t have to return {\ttfamily bool}. It works as long as the return value can be used as the condition in the statement {\ttfamily if (condition) ...}.\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md136}{}\doxysubsection{Matching Arguments that Are Not Copyable}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md136}
...
\cellcolor{\tableheadbgcolor}\textbf{ Expression   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
\endhead
{\ttfamily \mbox{\hyperlink{classField}{Field(\&\+Foo\+::number, Ge(3))}}}   &Matches {\ttfamily x} where {\ttfamily x.\+number $>$= 3}.    \\\cline{1-2}
...
{\ttfamily \mbox{\hyperlink{classField}{Field()}}} and {\ttfamily Property()} can also match plain pointers to objects. For instance,
...
Finally {\ttfamily \mbox{\hyperlink{classField}{Field()}}} and {\ttfamily Property()} provide overloads that take the field or property names as the first argument to include it in the error message. This can be useful when creating combined matchers.
...
\DoxyCodeLine{  \textcolor{keywordflow}{return} AllOf(\mbox{\hyperlink{classField}{Field}}(\textcolor{stringliteral}{"{}some\_field"{}}, \&Foo::some\_field, foo.some\_field),}
\DoxyCodeLine{               \mbox{\hyperlink{classField}{Field}}(\textcolor{stringliteral}{"{}other\_field"{}}, \&Foo::other\_field, foo.other\_field),}
\DoxyCodeLine{               \mbox{\hyperlink{classField}{Field}}(\textcolor{stringliteral}{"{}last\_field"{}}, \&Foo::last\_field, foo.last\_field));}
\DoxyCodeLine{\}}

\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md138}{}\doxysubsection{Validating the Value Pointed to by a Pointer Argument}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md138}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md139}{}\doxysubsection{Matching Containers}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md139}
...
\end{DoxyItemize}\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md140}{}\doxysubsection{Sharing Matchers}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md140}
...
This requirement must be satisfied no matter how a matcher is defined (e.\+g., if it is one of the standard matchers, or a custom matcher). In particular, a matcher can never call a mock function, as that will affect the state of the mock object and g\+Mock.\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md141}{}\doxysection{Setting Expectations}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md141}
...
Please note that once you expressed interest in a particular mock method (via {\ttfamily EXPECT\+\_\+\+CALL()}), all invocations to it must match some expectation. If this function is called but the arguments don\textquotesingle{}t match any {\ttfamily EXPECT\+\_\+\+CALL()} statement, it will be an error.\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md143}{}\doxysubsection{Disallowing Unexpected Calls}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md143}
...
This means that A must occur before B and C, and C must occur before D. There\textquotesingle{}s no restriction about the order other than these.\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md144}{}\doxysubsection{Controlling When an Expectation Retires}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md144}
...
Here \#2 can be used only once, so if you have two warnings with the message {\ttfamily \char`\"{}\+File too large.\char`\"{}}, the first will match \#2 and the second will match \#1 -\/ there will be no error.\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md145}{}\doxysection{Using Actions}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md145}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md146}{}\doxysubsection{Returning References from Mock Methods}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md146}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md147}{}\doxysubsection{Returning Live Values from Mock Methods}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md147}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md148}{}\doxysubsection{Combining Actions}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md148}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md149}{}\doxysubsection{Changing a Mock Object\textquotesingle{}s Behavior Based on the State}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md149}
...
Please note that changing the default value for a type can make your tests hard to understand. We recommend you to use this feature judiciously. For example, you may want to make sure the {\ttfamily Set()} and {\ttfamily Clear()} calls are right next to the code that uses your mock.\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md150}{}\doxysubsection{Setting the Default Actions for a Mock Method}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md150}
...
\end{DoxyItemize}\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md151}{}\doxysubsection{Using Functions with Extra Info as Actions}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md151}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md152}{}\doxysubsection{Invoking a Function/\+Method/\+Functor/\+Lambda/\+Callback Without Arguments}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md152}
...
\end{DoxyItemize}\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md153}{}\doxysubsection{Invoking an Argument of the Mock Function}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md153}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md154}{}\doxysubsection{Ignoring an Action\textquotesingle{}s Result}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md154}
...
\end{DoxyItemize}\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md155}{}\doxysubsection{Ignoring Arguments in Action Functions}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md155}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md156}{}\doxysubsection{Sharing Actions}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md156}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md157}{}\doxysubsection{Testing Asynchronous Behavior}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md157}
...
\{\+: .callout .note\} Note\+: this example has a downside\+: namely, if the expectation is not satisfied, our test will run forever. It will eventually time-\/out and fail, but it will take longer and be slightly harder to debug. To alleviate this problem, you can use {\ttfamily Wait\+For\+Notification\+With\+Timeout(ms)} instead of {\ttfamily Wait\+For\+Notification()}.\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md158}{}\doxysection{Misc Recipes on Using g\+Mock}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md158}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md159}{}\doxysubsection{Mocking Methods That Use Move-\/\+Only Types}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md159}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md160}{}\doxysubsection{Making the Compilation Faster}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md160}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md161}{}\doxysubsection{Forcing a Verification}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md161}
...
Also, remember that {\ttfamily Default\+Value$<$T$>$} is a global resource that potentially affects {\itshape all} living mock objects in your program. Naturally, you won\textquotesingle{}t want to mess with it from multiple threads or when there still are mocks in action.\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md163}{}\doxysubsection{Controlling How Much Information g\+Mock Prints}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md163}
...
Now, judiciously use the right flag to enable g\+Mock serve you better!\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md164}{}\doxysubsection{Gaining Super Vision into Mock Calls}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md164}
...
If you are interested in the mock call trace but not the stack traces, you can combine {\ttfamily -\/-\/gmock\+\_\+verbose=info} with {\ttfamily -\/-\/gtest\+\_\+stack\+\_\+trace\+\_\+depth=0} on the test command line.\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md165}{}\doxysubsection{Running Tests in Emacs}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md165}
...
Then you can type {\ttfamily M-\/m} to start a build (if you want to run the test as well, just make sure {\ttfamily foo\+\_\+test.\+run} or {\ttfamily runtests} is in the build command you supply after typing {\ttfamily M-\/m}), or {\ttfamily M-\/up}/{\ttfamily M-\/down} to move back and forth between errors.\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md166}{}\doxysection{Extending g\+Mock}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md166}
...
For convenience, we allow the description string to be empty ({\ttfamily \char`\"{}\char`\"{}}), in which case g\+Mock will use the sequence of words in the matcher name as the description.\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md167}{}\doxysubsubsection{Basic Example}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md167}
...
where the descriptions {\ttfamily \char`\"{}is divisible by 7\char`\"{}} and {\ttfamily \char`\"{}not (is divisible by 7)\char`\"{}} are automatically calculated from the matcher name {\ttfamily Is\+Divisible\+By7}.\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md168}{}\doxysubsubsection{Adding Custom Failure Messages}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md168}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md169}{}\doxysubsubsection{Using EXPECT\+\_\+ Statements in Matchers}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md169}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md170}{}\doxysubsubsection{$<$tt$>$\+Match\+And\+Explain$<$/tt$>$}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md170}
You should let {\ttfamily Match\+And\+Explain()} print {\itshape any additional information} that can help a user understand the match result. Note that it should explain why the match succeeds in case of a success (unless it\textquotesingle{}s obvious) -\/ this is useful when the matcher is used inside {\ttfamily Not()}. There is no need to print the argument value itself, as g\+Mock already prints it for you.\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md171}{}\doxysubsubsection{Argument Types}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md171}
The type of the value being matched ({\ttfamily arg\+\_\+type}) is determined by the context in which you use the matcher and is supplied to you by the compiler, so you don\textquotesingle{}t need to worry about declaring it (nor can you). This allows the matcher to be polymorphic. For example, {\ttfamily Is\+Divisible\+By7()} can be used to match any type where the value of {\ttfamily (arg \% 7) == 0} can be implicitly converted to a {\ttfamily bool}. In the {\ttfamily Bar(\+Is\+Divisible\+By7())} example above, if method {\ttfamily Bar()} takes an {\ttfamily int}, {\ttfamily arg\+\_\+type} will be {\ttfamily int}; if it takes an {\ttfamily unsigned long}, {\ttfamily arg\+\_\+type} will be {\ttfamily unsigned long}; and so on.\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md172}{}\doxysubsection{Writing New Parameterized Matchers Quickly}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md172}
...
\{\+: .callout .tip\} Tip\+: for convenience, {\ttfamily Match\+And\+Explain()} can take a {\ttfamily Match\+Result\+Listener$\ast$} instead of {\ttfamily std\+::ostream$\ast$}.\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md174}{}\doxysubsection{Writing New Polymorphic Matchers}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md174}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md175}{}\doxysubsection{Legacy Matcher Implementation}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md175}
...
Like in a monomorphic matcher, you may explain the match result by streaming additional information to the {\ttfamily listener} argument in {\ttfamily Match\+And\+Explain()}.\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md176}{}\doxysubsection{Writing New Cardinalities}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md176}
...
Typically the {\ttfamily Once\+Action} and {\ttfamily Action} templates need not be referenced directly in your actions\+: a struct or class with a call operator is sufficient, as in the examples above. But fancier polymorphic actions that need to know the specific return type of the mock function can define templated conversion operators to make that possible. See {\ttfamily \mbox{\hyperlink{gmock-actions_8h_source}{gmock-\/actions.\+h}}} for examples.\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md177}{}\doxysubsubsection{Legacy macro-\/based Actions}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md177}
...
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md178}{}\doxysubsubsection{Legacy macro-\/based parameterized Actions}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md178}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md179}{}\doxysubsection{Restricting the Type of an Argument or Parameter in an ACTION}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md179}
...
where {\ttfamily Static\+Assert\+Type\+Eq} is a compile-\/time assertion in googletest that verifies two types are the same.\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md180}{}\doxysubsection{Writing New Action Templates Quickly}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md180}
...
Are we using a single-\/template-\/parameter action where {\ttfamily bool} refers to the type of {\ttfamily x}, or a two-\/template-\/parameter action where the compiler is asked to infer the type of {\ttfamily x}?\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md181}{}\doxysubsection{Using the ACTION Object\textquotesingle{}s Type}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md181}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md182}{}\doxysubsection{Teaching g\+Mock How to Print Your Values}\label{md_build__deps_googletest_src_docs_gmock_cook_book_autotoc_md182}
