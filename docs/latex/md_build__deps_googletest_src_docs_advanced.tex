...
As with assertion macros, you can stream a custom message into {\ttfamily GTEST\+\_\+\+SKIP()}.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md27}{}\doxysection{Teaching Google\+Test How to Print Your Values}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md27}
...
For more details regarding {\ttfamily Absl\+Stringify()} and its integration with other libraries, see go/abslstringify.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md28}{}\doxysection{Regular Expression Syntax}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md28}
...
If you want to test {\ttfamily EXPECT\+\_\+$\ast$()/\+ASSERT\+\_\+$\ast$()} failures in your test code, see \href{\#catching-failures}{\texttt{ \char`\"{}\+Catching\char`\"{} Failures}}.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md30}{}\doxysubsection{How to Write a Death Test}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md30}
...
In particular, if {\ttfamily statement} generates an {\ttfamily ASSERT\+\_\+$\ast$} or {\ttfamily EXPECT\+\_\+$\ast$} failure, it will {\bfseries{not}} cause the death test to fail, as Google\+Test assertions don\textquotesingle{}t abort the process.\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md31}{}\doxysubsection{Death Test Naming}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md31}
...
\end{DoxyCode}
\hypertarget{md_build__deps_googletest_src_docs_advanced_autotoc_md32}{}\doxysubsection{How It Works}\label{md_build__deps_googletest_src_docs_advanced_autotoc_md32}
