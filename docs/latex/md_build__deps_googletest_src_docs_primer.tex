\hypertarget{md_build__deps_googletest_src_docs_primer_autotoc_md226}{}\doxysection{Introduction\+: Why Google\+Test?}\label{md_build__deps_googletest_src_docs_primer_autotoc_md226}
...
\cellcolor{\tableheadbgcolor}\textbf{ Meaning   }&\cellcolor{\tableheadbgcolor}\textbf{ Google\+Test Term   }&\cellcolor{\tableheadbgcolor}\textbf{ \href{https://www.istqb.org/}{\texttt{ ISTQB}} Term    }\\\cline{1-3}
\endhead
Exercise a particular program path with specific input values and verify the results   &\href{\#simple-tests}{\texttt{ TEST()}}   &\href{https://glossary.istqb.org/en_US/term/test-case}{\texttt{ Test Case}}   \\\cline{1-3}
\end{longtabu}
\hypertarget{md_build__deps_googletest_src_docs_primer_autotoc_md228}{}\doxysection{Basic Concepts}\label{md_build__deps_googletest_src_docs_primer_autotoc_md228}
...
We\textquotesingle{}ll now explain how to write a test program, starting at the individual assertion level and building up to tests and test suites.\hypertarget{md_build__deps_googletest_src_docs_primer_autotoc_md229}{}\doxysection{Assertions}\label{md_build__deps_googletest_src_docs_primer_autotoc_md229}
...
Google\+Test provides a collection of assertions for verifying the behavior of your code in various ways. You can check Boolean conditions, compare values based on relational operators, verify string values, floating-\/point values, and much more. There are even assertions that enable you to verify more complex states by providing custom predicates. For the complete list of assertions provided by Google\+Test, see the \mbox{\hyperlink{md_build__deps_googletest_src_docs_reference_assertions}{Assertions Reference}}.\hypertarget{md_build__deps_googletest_src_docs_primer_autotoc_md230}{}\doxysection{Simple Tests}\label{md_build__deps_googletest_src_docs_primer_autotoc_md230}
To create a test\+:
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_docs_primer_autotoc_md231}{}\doxysection{Invoking the Tests}\label{md_build__deps_googletest_src_docs_primer_autotoc_md231}
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_build__deps_googletest_src_docs_primer_autotoc_md232}{}\doxysection{Writing the main() Function}\label{md_build__deps_googletest_src_docs_primer_autotoc_md232}
...
\{\+: .callout .note\} NOTE\+: {\ttfamily Parse\+GUnit\+Flags()} is deprecated in favor of {\ttfamily Init\+Google\+Test()}.\hypertarget{md_build__deps_googletest_src_docs_primer_autotoc_md233}{}\doxysection{Known Limitations}\label{md_build__deps_googletest_src_docs_primer_autotoc_md233}
